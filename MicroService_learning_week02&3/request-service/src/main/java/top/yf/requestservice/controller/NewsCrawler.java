...
public class NewsCrawler {
    private static final String TARGET_URL = "https://tophub.today/c/news";
        ...
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpGet)) {
                ...
                if (entity != null) {
                    ...
                    Object[] titleNodes = rootNode.evaluateXPath("//*[@id=\"node-6\"]/div/div[2]/div[1]/a/div/span[2]");
                    ////*[@id="node-6"]/div/div[2]/div[1]/a[2]/div/span[2]
